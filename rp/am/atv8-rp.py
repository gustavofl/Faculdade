...
intervalo_sem = intervalo_confianca(lista_acuracia_holdout_sem_peso)[0]
intervalo_com = intervalo_confianca(lista_acuracia_holdout_com_peso)[0]
print("intervalo sem peso=",intervalo_sem)
print("intervalo com peso=",intervalo_com)
...
if(sobreposicao_intervalos(intervalo_com, intervalo_sem)):
	...
	if(intervalo_sem[1] > intervalo_com[1]):
		print("\tO 5-NN sem peso tem uma taxa de acerto maior!")
	else:
		print("\tO 5-NN com peso tem uma taxa de acerto maior!")